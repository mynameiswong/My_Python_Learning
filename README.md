...
Method Types
https://medium.com/@gmotzespina/method-types-in-python-2c95d46281cd
...
You could use a static method when you have a class but you do not need an specific instance in order to access that method. For example if you have a class called Math and you have a method called factorial (calculates the factorial of a number). You probably won’t need an specific instance to call that method so you could use a static method.
